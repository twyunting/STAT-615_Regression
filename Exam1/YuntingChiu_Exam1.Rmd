...
**Answer: False**
- One of the assumptions in the linear regression assumption is linearity.

##### The Four Assumptions of Linear Regression
a. Linear relationship: There exists a linear relationship between the independent variable, x, and the
dependent variable, y.\
b. Independence: The residuals are independent.\
c. Homoscedasticity: The residuals have constant variance at every level of x.\
d. Normality: The residuals of the model are normally distributed.
