...
- Equation: Length = 13.5330 + 5.4030*Conc
```{r}
...
- Because 0.1378 > 0.07566, also the p-value is far away to the $\alpha$ level. We can conclude that the Box-Cox transformation improves residual normality.
```{r}
attach(muscle)
z <- Length^(1.353535)
newReg2 <- lm(z~Conc)
