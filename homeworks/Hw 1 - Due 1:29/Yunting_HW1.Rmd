...
- we use two-sided t.test, and the answer is Server A and Server B is significant difference.
...
tout <- t.test(x = homeSales$SALES_PRICE[homeSales$AIR_CONDITIONER == "YES"], y = homeSales$SALES_PRICE[homeSales$AIR_CONDITIONER == "NO"])
