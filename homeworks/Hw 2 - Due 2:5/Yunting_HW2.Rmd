...
- X is Mileage, y is Miles per gallon. The y-intercept that I computed is 24.77155. That is, if mileage add one unit, the Miles per gallon will have 24.77155 increment.
- reference: https://www.google.com/search?q=least+squares+regression+line+mean+standard+deviation&rlz=1C5CHFA_enUS920US920&oq=east+squares+regression+mean+de&aqs=chrome.1.69i57j0i22i30l4.8645j1j9&sourceid=chrome&ie=UTF-8#kpvalbx=_lJMZYKK_EIqw5NoPqMOIuAg21
...
- The slope implies a line's steepness and the intercept shows the position where an y-axis intersects. That is, y intercept is on 24.77155 of y-axis.
